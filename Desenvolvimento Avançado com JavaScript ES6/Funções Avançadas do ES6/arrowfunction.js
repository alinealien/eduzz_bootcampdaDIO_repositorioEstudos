// Arrow Functions: (=>) Funções anónimas, só pode utiliza-las  ou atribuindo a uma variável ou passando como parâmetro para uma outra função. No JS as funções são de primeira classe.
